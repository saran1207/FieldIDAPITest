...
update masterevents me set completeddate = null,performedby_id = null,status="VOID" where completeddate is not null and event_state="OPEN" and me.event_id not in (select id from completed_open_events_that_have_results);
