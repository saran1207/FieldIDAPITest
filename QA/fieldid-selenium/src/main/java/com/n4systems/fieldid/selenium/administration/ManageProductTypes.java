...
public class ManageProductTypes {
	 ...
	 * @param attributes
	 */
	public void deleteProductTypeAttributes(List<Attribute> attributes) {
	 ...
	 * @param delete
	 */
	private void deleteRetireProductTypeAttributeHelper(List<Attribute> attributes, boolean delete) {
		...
		while(i.hasNext()) {
			Attribute a = i.next();
			String deleteLocator = "xpath=//INPUT[@value='" + a.getName() + "']/../../DIV[contains(@class,'linkCol')]/A[contains(text(),'" + linkText + "')]";
	...
	public void retireProductTypeAttributes(List<Attribute> attributes) {
