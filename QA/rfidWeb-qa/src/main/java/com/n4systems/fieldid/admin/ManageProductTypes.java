...
public class ManageProductTypes extends TestCase {
	...
	public ManageProductTypes(IE ie) {
		...
		try {
			...
			manageProductTypesFinder = xpath(p.getProperty("manageproducttype"));
			manageProductTypesContentHeader = xpath(p.getProperty("listproducttypecontentheader"));
			addProductTypeFinder = xpath(p.getProperty("addproducttype"));
			addProductTypeGroupFinder = id(p.getProperty("addproducttypegroup"));
			addProductTypeNameFinder = id(p.getProperty("addproducttypename"));
			addProductTypeWarningsFinder = id(p.getProperty("addproducttypewarnings"));
			addProductTypeInstructionsFinder = id(p.getProperty("addproducttypeinstructions"));
			addProductTypeCautionsURLFinder = id(p.getProperty("addproducttypecautionsurl"));
			addProductTypeHasManufacturerCertificate = id(p.getProperty("addproducttypehasmanufacturercertificate"));
			addProductTypeManufacturerCertificateTextFinder = id(p.getProperty("addproducttypemanufacturercertificate"));
			addProductTypeProductDescriptionTemplateFinder = id(p.getProperty("addproducttypeproductdescriptiontemplate"));
			addProductTypeUploadImageFinder = id(p.getProperty("addproducttypeuploadimage"));
			addProductTypeAddAttributesButtonFinder = xpath(p.getProperty("addproducttypeaddattributesbutton"));
			addProductTypeAttachAFileButtonFinder = text(p.getProperty("addproducttypeattachafilebutton"));
			addProductTypeSaveButtonFinder = id(p.getProperty("addproducttypesavebutton"));
			viewProductTypeContentHeader = xpath(p.getProperty("viewproducttypecontentheader"));
			editProductTypeLink2Finder = xpath(p.getProperty("editproducttype2"));
			editProductTypeDeleteButtonFinder = xpath(p.getProperty("editproducttypedeletebutton"));
			confirmDeleteProductTypeContentHeaderFinder = xpath(p.getProperty("confirmproducttypedeletepageheader"));
			confirmDeleteProductTypeDeleteButtonFinder = id(p.getProperty("confirmproducttypedeletedeletebutton"));
			addProductTypeAttributeButtonFinder = xpath(p.getProperty("addproducttypeattributeaddbutton"));
			productTypeViewAllLinkFinder = xpath(p.getProperty("viewalllink"));
			manageProductTypesLinksFinder = xpath(p.getProperty("manageproducttypeslinks"));
			manageProductTypeInspectionTypeLinkFinder = xpath(p.getProperty("manageproducttypeinspectiontypes"));
			saveInspectionTypesFinder = xpath(p.getProperty("inspectiontypessavebutton"));
			subComponentsFinder = xpath(p.getProperty("manageproducttypesubcomponents"));
			subComponentListFinder = xpath(p.getProperty("subcomponentlist"));
			subComponentSelectListFinder = xpath(p.getProperty("subcomponentselectlist"));
			addSubComponentButtonFinder = xpath(p.getProperty("addsubcomponentbutton"));
			saveSubComponentsButtonFinder = xpath(p.getProperty("savesubcomponentsbutton"));
