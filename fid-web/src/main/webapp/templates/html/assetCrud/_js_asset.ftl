...
asset.assetStatus="${(asset.assetStatus.name)!}";
asset.identifier = '${asset.identifier?html?js_string}';
...
asset.nextScheduledEvent='${action.formatDate(asset.identified, false)?html?js_string}';
