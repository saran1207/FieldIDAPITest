...
<div class="definition" id="subAssetDefinition_${subAsset.asset.id}">
	<div class="identifier">
		...
		<div class="subAssetLabel ">${(subAsset.label?html)!} <a href="_header.ftl#change" class="notAllowedDuringOrdering" onclick="$('subAssetDefinition_${subAsset.asset.id}').hide(); $('subAssetLabelForm_${subAsset.asset.id}').show(); return false;"><@s.text name="label.change_label"/></a></div>
	</div>
	<div class="subAssetActions">
		...
		<div class="subAssetAction removeSubAsset">
			<a href="_header.ftl#removeSubAsset" id="removeSubAsset_${subAsset.asset.id}" onclick="removeSubAsset( '${subAsset.asset.id}' ); return false;"><img src="<@s.url value="/images/x.gif"/>" alt="<@s.text name="label.remove"/>"/></a>
		</div>
	</div>
</div>
...
<div class="labelForm" style="display:none" id="subAssetLabelForm_${subAsset.asset.id}">
	<@s.form action="${updateSubAssetAction!'updateSubAsset'}" id="subAssetForm_${subAsset.asset.id}" namespace="/ajax" theme="fieldid">
		...
		<a href="_header.ftl#" onclick="$('subAssetDefinition_${subAsset.asset.id}').show(); $('subAssetLabelForm_${subAsset.asset.id}').hide(); $('subAssetForm_${subAsset.asset.id}').reset(); return false;"><@s.text name="label.cancel"/></a>
	</@s.form>
