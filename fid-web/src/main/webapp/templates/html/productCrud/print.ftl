...
The manufacturer certificate for the product you just created should begin downloading automatically if it doesn't click <a target="_blank" href="<@s.url action="downloadManufacturerCert" namespace="/file" includeParams="none" uniqueID="${asset.uniqueID}" />">here</a>.
</p>
<p>
