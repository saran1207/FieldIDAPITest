	...
	<#if !criteria.retired >
		...
		<div class="infoSet" >
			...
			<div class="recDefButtons">
				...
				<a id='recButton_${criteria.id}' href='#rec_${criteria.id}' class='recDefLightBox' ><img id='recImage_${criteria.id}' src="<@s.url value="/images/rec.png"/>" /></a>
				<a id='defButton_${criteria.id}' href='#def_${criteria.id}' class='recDefLightBox' ><img id='defImage_${criteria.id}' src="<@s.url value="/images/def.png"/>" /></a>
			</div>
