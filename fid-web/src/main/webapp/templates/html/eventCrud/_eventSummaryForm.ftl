...
<div id="assetSummary" class="assetSummary">
	...
	<div class="infoSet">
		...
		<span class="fieldHolder">
            <a href="<@s.url value="w/assetSummary?uniqueID=${asset.id}"/>">${asset.identifier?html}</a>
		</span>
	</div>
	<div class="infoSet">
...
<#if action.isParentAsset() >
    ...
    <div class="infoSet">
        ...
        <span class="fieldHolder">
            <@s.textfield theme="fieldid" name="modifiableEvent.dueDate" cssClass="datetimepicker"/>
        </span>
    </div>
