							...
							<li>
								...
								<ul class="sub_menu">
									...
									<li>
										...
										<#if sessionUser.hasAccess("managesystemconfig") >
											<ul class="sub_menu">
												<li><a href="<@s.url value='/w/eventTypeGroup' namespace='/'/>" ><@s.text name="title.manage_event_type_groups.plural"/></a></li>
												...
												<li><a href="<@s.url value='/w/setup/assetTypeGroupsList' namespace='/'/>" ><@s.text name="title.manage_asset_type_groups.plural"/></a></li>
