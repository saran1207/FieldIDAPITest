<#if org.addressInfo??>
    ...
    <p><#if org.addressInfo.city??>${org.addressInfo.city}</#if><#if org.addressInfo.state??>, ${org.addressInfo.state}</#if><#if org.addressInfo.country??>, ${org.addressInfo.country}</#if>
    </p>
