...
<div id="dashboardShortCuts" class="dashboardBlock">
	<div id="quickLinks" class="dashboardSection">
		...
		<ul class="bulletList quickLinkList">
            ...
            <li><a href="/fieldid/w/wicket/reporting2"><@s.text name="label.vieweventhistory"/></a></li>
            <li><a href="/fieldid/w/wicket/procedure"><@s.text name="label.vieweventhistory"/></a></li>
