<div style="display: none;">
    <div class="observationBox" id="def_${criteria.id}" >
            ...
            <#if stateValue != "COMMENT">
                ...
                <p id="def_${criteria.id}_${deficiency_index}" class="observationText ${selectClass}" onclick="cycleDeficiency(${criteria.id}, ${deficiency_index})" >
                    ...
                    <#if (criteriaResults[criteriaCount].deficiencies[deficiency_index].id)?exists >
                        <@s.hidden id="def_${criteria.id}_${deficiency_index}_id" name="criteriaResults[${currentCriteriaIndex}].deficiencies[${deficiency_index}].iD" value="${criteriaResults[criteriaCount].deficiencies[deficiency_index].id}" />
                    </#if>
        ...
        <p class="observationComment" >
            ...
            <#if (criteriaResults[criteriaCount].deficiencies[criteria.deficiencies.size()].id)?exists >
                <@s.hidden id="def_${criteria.id}_${criteria.deficiencies.size()}_id" name="criteriaResults[${currentCriteriaIndex}].deficiencies[${criteria.deficiencies.size()}].iD" value="${criteriaResults[criteriaCount].deficiencies[criteria.deficiencies.size()].id}" />
            </#if>
