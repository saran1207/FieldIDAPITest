							...
							<p>
								...
								<span>
									<#if inspectionProcessingFailureMap[key][serialnumber]?exists>
										<a href='<@s.url action="inspection" namespace="/aHtml/iframe"  assetId="${inspectionProcessingFailureMap[key][serialnumber].asset.uniqueID}" uniqueID="${inspectionProcessingFailureMap[key][serialnumber].id}"/>'  class='lightview' rel='iframe' title='<@s.text name="title.viewinspection"/> :: :: scrolling:true, width: 520, height: 420' >
