<@s.form action="eventCreate" namespace="/multiEvent/ajax" id="eventCreate" theme="fieldid" cssClass="eventCreateForm">
	...
	<div class="infoSet">
		...
		<div class="fieldHolder">
			<span class="multiEventLocation">
                <span class="locationTree">
                    <@n4.location name="modifiableEvent.location" nodesList=predefinedLocationTree fullName="${helper.getFullNameOfLocation(modifiableEvent.location)}"  theme="simple"/>
                </span>
            </span>
			<span class="fieldHolder">	
