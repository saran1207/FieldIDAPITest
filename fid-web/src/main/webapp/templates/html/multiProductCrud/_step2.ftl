...
<div class="stepContent" id="step2" style="display:none">
	<p>${action.getTextArg("label.how_many_assets", maxProducts)}</p>
	...
	<div class="formRowHolder">
		...
		<div id="quantityInvalid" style="display: none;" class="errorMessage">${action.getTextArg("error.invalid_quantity", maxProducts)}</div>
	</div>
