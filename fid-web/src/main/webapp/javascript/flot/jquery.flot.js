    ...
    function Plot(placeholder, data_, options_, plugins) {
        ...
        function insertLegend() {
            ...
            for (var i = 0; i < series.length; ++i) {
                ...
                fragments.push(
                    '<td class="legendColorBox"><div style="border:1px solid ' + options.legend.labelBoxBorderColor + ';padding:1px"><div style="height:0;border:5px solid ' + s.color + ';overflow:hidden"></div></div></td>' +
