(function ($) {
    ...
    var RSS = function (target, url, options, callback) {
        ...
        this.options = $.extend({
            ...
            limit: 3,
            key: null,
            layoutTemplate: '<ul style="list-style-type:none">{entries}</ul>',
            entryTemplate: '<li><table style="width: 100%"><tr><td style="width: 70%"><a href="{url}">{title}</a></td><td style="width: 30%">{date}</td></tr></table></li>',
            tokens: {},
            outputMode: 'json',
