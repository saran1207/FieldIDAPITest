...
Calendar.prototype.getMonthlyCalendarCode = function() {
	...
	vCode += "</TABLE><TABLE><TR><TD height=1></TD></TR></TABLE></div>";
...
Calendar.prototype.show = function() {
	...
	ggWinContent += ("<TABLE WIDTH='100%' BORDER=0 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#ffffff' style='font-size:" + fontsize + "pt;'><TR><TD ALIGN=center>");
	ggWinContent += ("<A HREF=\"javascript:void(0);\" " +
		"onClick=\"Build(" +
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)-1) + "', '" + this.gFormat + "'" +
		");" +
		"\"><img src='images\\but_prevyear.gif' border=0 alt='Go back one year'></img><\/A></TD><TD ALIGN=center>");
	ggWinContent += ("<A HREF=\"javascript:void(0);\" " +
		"onClick=\"Build(" +
		"'" + this.gReturnItem + "', '" + prevMM + "', '" + prevYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><img src='images\\but_prevmonth.gif' border=0 alt='Go back one month'></img><\/A></TD><TD ALIGN=center>");
	ggWinContent += "&nbsp;</TD><TD ALIGN=center>";
	ggWinContent += ("<A HREF=\"javascript:void(0);\" " +
		"onClick=\"Build(" +
		"'" + this.gReturnItem + "', '" + nextMM + "', '" + nextYYYY + "', '" + this.gFormat + "'" +
		");" +
		"\"><img src='images\\but_nextmonth.gif' border=0 alt='Go forward one month'></img><\/A></TD><TD ALIGN=center>");
	ggWinContent += ("<A HREF=\"javascript:void(0);\" " +
		"onClick=\"Build(" +
		"'" + this.gReturnItem + "', '" + this.gMonth + "', '" + (parseInt(this.gYear)+1) + "', '" + this.gFormat + "'" +
		");" +
		"\"><img src='images\\but_nextyear.gif' border=0 alt='Go forward one year'></img><\/A></TD></TR><TR><TD height=5></TD></TR></TABLE>");
...
Calendar.prototype.showY = function() {
	...
	ggWinContent += ("<TABLE WIDTH='100%' BORDER=0 CELLSPACING=0 CELLPADDING=0 BGCOLOR='#f0f0f0' style='font-size:" + fontsize + "pt;'><TR><TD ALIGN=center>");
	ggWinContent += ("[<A HREF=\"javascript:void(0);\" " +
...
Calendar.prototype.cal_header = function() {
	...
	vCode = vCode + "<TR>";
	vCode = vCode + "<TD width=18><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'>Su</FONT></TD>";
	vCode = vCode + "<TD width=18><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'>Mo</FONT></TD>";
	vCode = vCode + "<TD width=18><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'>Tu</FONT></TD>";
	vCode = vCode + "<TD width=18><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'>We</FONT></TD>";
	vCode = vCode + "<TD width=18><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'>Th</FONT></TD>";
	vCode = vCode + "<TD width=18><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'>Fr</FONT></TD>";
	vCode = vCode + "<TD width=18><FONT FACE='" + fontface + "' COLOR='" + this.gHeaderColor + "'>Sa</FONT></TD>";
	vCode = vCode + "</TR>";
...
Calendar.prototype.cal_data = function() {
	...
	*/
	...
	for (i=0; i<vFirstDay; i++) {
		vCode = vCode + "<TD" + this.write_weekend_string(i) + "><FONT FACE='" + fontface + "'>&nbsp;</FONT></TD>";
	}

	// Write rest of the 1st week
	for (j=vFirstDay; j<7; j++) {
		vCode = vCode + "<TD" + this.write_weekend_string(j) + "><FONT FACE='" + fontface + "'>" +
			"<A style='{color:#000000} {text-decoration:none}' HREF='javascript:void(0);' " +
...
//	gCal.gBGColor="white";
	...
	if (ggPosX == -1 && ggPosY == -1) {
		overlib(ggWinContent, AUTOSTATUSCAP, STICKY, CLOSECLICK, CSSSTYLE,
			...
			CAPTION, "Select a date", OFFSETX, -25, OFFSETY, 15);
...
*/
    p_format = arguments[2].toUpperCase();
    hqx=0;
	ggPosX=-1;
	ggPosY=-1;
	...
	if (arguments[1] != null && arguments[1] !='') {
        passedDate = arguments[1];
        var year, month;

		switch (p_format) {
	   		case "MM\/DD\/YYYY" :
			case "MM-DD-YYYY" :
				year = passedDate.substring(6,10);
				month = passedDate.substring(0,2);
				break;
	   		case "YYYY\/MM\/DD" :
			case "YYYY-MM-DD" :
				year = passedDate.substring(0,4);
				month = passedDate.substring(5,7);
				break;
			case "DD\/MM\/YYYY" :
			case "DD-MM-YYYY" :
				year = passedDate.substring(6,10);
				month = passedDate.substring(3,5);
				break;
			default :
				year = p_year;
				month = p_month;
		...
		if (year>"1970" && year<"2100" && month>"00" && month<"13") {
			p_year = year;
			p_month = eval(month-1);
		}
	}
