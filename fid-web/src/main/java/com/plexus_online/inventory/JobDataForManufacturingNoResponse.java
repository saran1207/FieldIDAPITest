...
@XmlRootElement(name = "JobDataForManufacturingNoResponse")
public class JobDataForManufacturingNoResponse {

    @XmlElement(name = "Job")
    protected JobDataForManufacturingNoResponse.Job job;
     ...
     * @return
     *     possible object is
     *     {@link JobDataForManufacturingNoResponse.Job }
     *     
     */
    public JobDataForManufacturingNoResponse.Job getJob() {
        return job;
    }
     ...
     *     
     */
    public void setJob(JobDataForManufacturingNoResponse.Job value) {
        this.job = value;
    }
