...
public class TemplateAssetSummaryPage extends AssetPage {
    ...
    public TemplateAssetSummaryPage(Asset asset) {
        this(new PageParameters().add("uniqueID",asset.getId()).add("useContext","false"));
    }

    public TemplateAssetSummaryPage(int id) {
        this(new PageParameters().add("uniqueID",id).add("useContext","false"));
    }

    public TemplateAssetSummaryPage(PageParameters params) {
        super(params);
            ...
            protected File load() {
                ...
                try {
                    ...
                    for (AssetAttachment assetAttachment: assetAttachments) {
                        File assetAttachmentFile = s3Service.downloadAssetAttachmentFile(assetAttachment);
                        ZipFileUtil.addToZipFile(assetAttachmentFile, zipOut);
                    }
