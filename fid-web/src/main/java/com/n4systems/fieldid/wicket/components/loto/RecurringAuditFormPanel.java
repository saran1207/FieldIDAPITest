...
public class RecurringAuditFormPanel extends Panel {
    ...
    public RecurringAuditFormPanel(String id, IModel<Asset> assetModel) {
        super(id, assetModel);
    ...
    protected class RecurringEventsForm extends Form implements IFormValidator {
        ...
        public RecurringEventsForm(String id) {
            ...
            FidDropDownChoice procedureAuditsSelect;
            inputContainer.add(procedureAuditsSelect = new FidDropDownChoice<ProcedureAuditEventType>("procedureAudits",
                    new PropertyModel<ProcedureAuditEventType>(this, "auditEventType"),
                    eventTypeService.getProcedureAuditEventTypes(),
                    new EventTypeChoiceRenderer<ProcedureAuditEventType>()));
            procedureAuditsSelect.setRequired(true);
            procedureAuditsSelect.setNullValid(true);

            FidDropDownChoice procedureDefSelect;
            inputContainer.add(procedureDefSelect = new FidDropDownChoice<ProcedureDefinition>("procedureDefs",
                    new PropertyModel<ProcedureDefinition>(this, "procedureDefinition"),
                    procedureDefinitionsList,
                    procedureDefRenderer));
            ...
            inputContainer.add(new AjaxSubmitLink("create") {
                @Override protected void onSubmit(AjaxRequestTarget target, Form<?> form) {
                    RecurringLotoEvent newEvent = new RecurringLotoEvent(auditEventType, procedureDefinition, assignee, createRecurrence());
