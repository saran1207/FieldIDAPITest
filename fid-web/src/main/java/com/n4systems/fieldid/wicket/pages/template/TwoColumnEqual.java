...
public class TwoColumnEqual extends FieldIDTemplatePage {

    public TwoColumnEqual() {
    }
    ...
    protected void addBreadCrumbBar(String breadCrumbBarId) {
        add(new BreadCrumbBar(breadCrumbBarId,
                ...
                new NavigationItem(new FIDLabelModel("label.current_page"), TwoColumnEqual.class)
        ));
    }
    ...
    class ActionGroup extends Fragment {
        ...
        public ActionGroup(String id) {
            super(id, "actions", TwoColumnEqual.this);
