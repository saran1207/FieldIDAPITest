...
public class DraftListAllPage extends ProceduresAllListPage{
    ...
    private class ProcedureDefinitionDataProvider extends FieldIDDataProvider<ProcedureDefinition> {
        ...
        public Iterator<? extends ProcedureDefinition> iterator(int first, int count) {
            List<? extends ProcedureDefinition> procedureDefinitionList = procedureDefinitionService.getAllDraftProcedures(getSort().getProperty(), getSort().isAscending(), first, count);
