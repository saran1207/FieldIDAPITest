...
public abstract class ObservationsViewPanel<T extends Observation> extends Panel {

    protected IModel<CriteriaResult> criteriaResultModel;
    private String comments;

    public ObservationsViewPanel(String id, final IModel<CriteriaResult> criteriaResultModel,
            ...
            protected void populateItem(final ListItem<String> item) {
                item.add(new AjaxEventBehavior("onclick") {
                    ...
                    protected void onEvent(AjaxRequestTarget target) {
                        ...
                        target.add(ObservationsViewPanel.this);
                    }
                });
