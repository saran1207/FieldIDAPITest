...
public class MattBar extends Panel {
    ...
    public void renderHead(IHeaderResponse response) {
        ...
        response.renderOnDomReadyJavaScript("$('.tipsy').remove(); if (typeof($('.tipsy-tooltip').tipsy)!='undefined') { $('.tipsy-tooltip').tipsy({gravity: 'nw', fade:true, delayIn:150, live:true}); }");
    }
