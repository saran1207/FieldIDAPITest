 ...
 */
public class EventTypeGroupListPage extends EventTypeGroupPage {
    ...
    protected void onInitialize() {
        ...
        dataProvider = new EventTypeGroupDataProvider("name", SortOrder.ASCENDING, Archivable.EntityState.ACTIVE);
