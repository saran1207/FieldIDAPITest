 ...
 */
public class LockoutWidgetsTab extends Panel {
    ...
    public LockoutWidgetsTab(String id, IModel<DashboardLayout> currentLayoutModel) {
        super(id);
    ...
    private LoadableDetachableModel<List<WidgetType>> createWidgetListModel() {
        return new LoadableDetachableModel<List<WidgetType>>() {
            ...
            protected List<WidgetType> load() {
                ...
                List<WidgetType> lotoList = new ArrayList<WidgetType>();

                for(WidgetType widgetType:widgetTypeList) {
                    if(widgetType.isLoto()){
                        lotoList.add(widgetType);
                    }
                }
                return lotoList;
            }
