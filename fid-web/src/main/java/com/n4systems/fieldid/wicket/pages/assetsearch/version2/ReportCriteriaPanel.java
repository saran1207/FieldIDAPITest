...
import com.n4systems.fieldid.wicket.pages.assetsearch.version2.components.SearchColumnsPanel;
...
public class ReportCriteriaPanel extends AbstractCriteriaPanel<EventReportCriteria> {
    ...
    @Override
    protected Panel createFiltersPanel(Model<EventReportCriteria> model) {
...
//            }
    ...
    @Override
    protected SearchColumnsPanel createColumnsPanel(Model<EventReportCriteria> eventReportCriteriaModel) {
        return null;
    }
