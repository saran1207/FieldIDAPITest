...
//This component uses the new template markup
public class MenuButton2<T> extends Panel {
    ...
    public MenuButton2(String id, IModel<String> label, List<T> items) {
        super(id);
        this.labelModel = label;
        setOutputMarkupId(true);
        add(new AttributeAppender("class", "split-btn").setSeparator(" "));
    ...
    public MenuButton2 withNoAjax() {
        ajaxButton = false;
        return this;
    }

    public MenuButton2 withAjax() {
        ajaxButton = true;
        return this;
    }

    class MenuButtonOptions implements Serializable {
        private boolean ajaxButton=MenuButton2.this.ajaxButton;
    }
