...
public class AssetImportPage extends FieldIDFrontEndPage {
    ...
    public AssetImportPage(PageParameters params) {
        super(params);
        //taskRegistry = new ImportTaskRegistry();
        StringValue preSelectedAssetTypeId = params.get(ASSET_TYPE_ID_KEY);
    ...
    protected Label createTitleLabel(String labelId) {
        return new Label(labelId, new FIDLabelModel("title.asset_import"));
    }
    ...
    /* Override to keep WebSessionMap out of this object's state since the session object in
       WebSessionMap is not serializable */
    @Override
