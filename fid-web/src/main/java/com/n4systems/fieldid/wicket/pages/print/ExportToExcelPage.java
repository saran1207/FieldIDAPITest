...
public class ExportToExcelPage extends PrintPage<EventReportCriteriaModel> {

    private @SpringBean EventExcelExportService excelExportService;

    public ExportToExcelPage(IModel<EventReportCriteriaModel> criteria) {
        super(criteria);
    }

    @Override
    protected DownloadLink createDownloadLink() {
        final EventReportCriteriaModel criteriaObject = criteria.getObject();
    ...
    private void storeLocalizedNamesInColumns(EventReportCriteriaModel criteriaObject) {
