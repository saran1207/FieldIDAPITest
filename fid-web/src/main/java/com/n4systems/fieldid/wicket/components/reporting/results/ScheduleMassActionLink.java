...
@Deprecated
public class ScheduleMassActionLink extends LegacySRSMassActionLink<EventReportCriteriaModel, EventScheduleSearchContainer> {
    public ScheduleMassActionLink(String id, String url, IModel<EventReportCriteriaModel> reportCriteriaModel) {
        super(id, url, reportCriteriaModel);
    }

    @Override
    protected EventScheduleSearchContainer convertAndStoreCriteria(EventReportCriteriaModel criteriaModel, HttpSession session) {
