...
public class MultiEventScheduleListHelper {
	...
	public Long getSuggestedEventScheduleIdForAsset(Asset asset){
		List<EventSchedule> eventSchedules = getEventSchedulesForAsset(asset);
		...
		EventSchedule suggestedSchedule = new EventScheduleSuggestion(eventSchedules).getSuggestedSchedule();
