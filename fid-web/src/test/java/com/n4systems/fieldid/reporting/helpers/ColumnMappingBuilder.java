...
public class ColumnMappingBuilder implements Builder<ColumnMappingView> {
	...
	public ColumnMappingView build() {
		return new ColumnMappingView(id, label, pathExpression, sortExpression, outputHandler, sortable, onByDefault, order, requiredExtendedFeature, null, null, null, false);
	}
