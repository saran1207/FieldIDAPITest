...
public class ProductSearchContainerTest extends SearchContainerTest {
	...
	public void setUp() {
		...
		productSearchContainer = new ProductSearchContainer(filter, new TestDoubleLoaderFactory(filter));
	}

	@Test
	public void single_search_term_non_wildcard() throws Exception {
		productSearchContainer.setRfidNumber("testsearch");

		WhereParameter<?> whereClause = getSingleWhereClause(productSearchContainer);
	...
	public void single_search_term_no_asterisk_should_be_eq_comparator() throws Exception {
		productSearchContainer.setSerialNumber("12345");
	...
	public void single_simple_term_date_range() throws Exception {
		productSearchContainer.setFromDate(dateFormat.parse("05/02/1990"));
		productSearchContainer.setToDate(dateFormat.parse("09/09/2010"));

		SearchTermDefiner term = getSingleSearchTerm(productSearchContainer);
	...
	public void test_search_with_wildcard() throws Exception {
		productSearchContainer.setSerialNumber("555*");
