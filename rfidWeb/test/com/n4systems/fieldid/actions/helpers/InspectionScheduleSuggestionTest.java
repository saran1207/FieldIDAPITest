...
public class InspectionScheduleSuggestionTest {
	...
	@Test public void test_suggested_schedule_with_no_schedulesid() {
	...
	@Test public void test_suggested_schedule_with_1_schedule_inside_30_days() {
		List<InspectionSchedule> schedules = new ArrayList<InspectionSchedule>();
	...
	@Test public void test_suggested_schedule_with_2_schedule_inside_30_days() {
		List<InspectionSchedule> schedules = new ArrayList<InspectionSchedule>();
		schedules.add(createSchedule(DateHelper.getTomorrow(), 1L));
	...
	@Test public void test_suggested_schedule_with_yesterday_vs_tomorrow() {
		List<InspectionSchedule> schedules = new ArrayList<InspectionSchedule>();
		schedules.add(createSchedule(DateHelper.getTomorrow(), 1L));
	...
	@Test public void test_suggests_no_schedule_when_schedules_are_more_than_30_days_away() {
		List<InspectionSchedule> schedules = new ArrayList<InspectionSchedule>();
	...
	@Test public void test_suggested_schedule_with_today_vs_yesterday() {
		List<InspectionSchedule> schedules = new ArrayList<InspectionSchedule>();
	...
	@Test public void test_suggested_schedule_with_today_vs_tomorrow() {
		List<InspectionSchedule> schedules = new ArrayList<InspectionSchedule>();
		schedules.add(createSchedule(DateHelper.getToday(), 1L));
