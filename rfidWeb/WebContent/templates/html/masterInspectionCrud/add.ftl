		...
		<div id="subProductType_${type.id}" class="component"> 
			<div class="definition">
				...
				<div class="createOptions">
					<a href="<@s.url action="productAdd" namespace="/ajax"  productTypeId="${type.id}" token="${token}"/>" onclick="addSubProduct(${type.id}, ${(product.jobSite.id)!"null"}); return false"><@s.text name="label.add_new" /></a> | 
