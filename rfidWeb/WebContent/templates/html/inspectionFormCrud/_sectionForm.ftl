	...
	<div id="criteriaSection_${section_index}" 
		...
		<h2 class="criteriaSectionHead" >
			<span class="criteriaSectionTitle" >
				...
				<a href="javascript:void(0);" onclick="retireSection(${section_index}); changeToForm(); return false;"><img src="<@s.url value="/images/retire.gif" includeParams="none"/>" /></a>
			</span>
			${addCriteriaButton}
		</h2>
