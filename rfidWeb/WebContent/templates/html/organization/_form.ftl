<head>
	...
	<script type="text/javascript">
		...
		function removeUploadImage() { 
			...
			var iframe = '<iframe id="imageUpload" src="<@s.url action="uploadImageForm" namespace="/aHtml" />" scrollbar="no" style="overflow:hidden;" frameborder="0" width="500" height="35" ></iframe>';
		...
		<div class="infoSet">
			...
			<span id="imageUploadField"  >
				...
				<#if !certImageDirectory?exists || certImageDirectory.length() == 0  || removeImage >
					<iframe id="imageUpload" src="<@s.url action="uploadImageForm" namespace="/aHtml" includeParams="none"/>" scrollbar="no" style="overflow:hidden;" frameborder="0" width="500" height="35" ></iframe>
				</#if>
