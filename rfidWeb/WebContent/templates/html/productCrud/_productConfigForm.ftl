...
<div class="multiColumn">
	...
	<div class="infoSet infoBlock">
		...
		<#else>
			<span class="fieldHolder" id="location">${(product.location)!}</span>
		</#if>
	</div>
	<div class="infoSet infoBlock">
...
<div class="infoSet">
	...
	<span class="fieldHolder">
		<@s.select name="commentTemplate" list="commentTemplates" listKey="id" listValue="name" emptyOption="true" onchange="changeComments(this)" theme="fieldidSimple"/><br/>
