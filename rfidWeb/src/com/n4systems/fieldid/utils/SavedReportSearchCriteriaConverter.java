...
public class SavedReportSearchCriteriaConverter {
	...
	public InspectionSearchContainer convert(SavedReport savedReport) {
		...
		container.setInspector(savedReport.getLongCriteria(SavedReport.INSPECTOR));
		container.setAssingedUser(savedReport.getLongCriteria(SavedReport.ASSINGED_USER));
	...
	public SavedReport convertInto(InspectionSearchContainer container, SavedReport report) {
		...
		report.setInCriteria(SavedReport.INSPECTOR, container.getInspector());
		...
		report.setInCriteria(SavedReport.ASSINGED_USER, container.getAssingedUser());
