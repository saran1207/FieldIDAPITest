...
public class ChangeSecurityCard extends AbstractCrud {
	...
	public ChangeSecurityCard(User userManager, PersistenceManager persistenceManager) {
	...
	public String doUpdate() {
		UserBean user = userManager.findUser( getSessionUser().getUniqueID(), getTenantId() );
