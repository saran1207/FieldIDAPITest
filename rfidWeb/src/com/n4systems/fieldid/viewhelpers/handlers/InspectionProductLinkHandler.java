...
public class InspectionProductLinkHandler implements OutputHandler {
	private final PersistenceManager persistenceManager;
	private final QueryBuilder<Long> builder = new QueryBuilder<Long>(Inspection.class, new OpenSecurityFilter());
	
	public InspectionProductLinkHandler() {
