...
import com.n4systems.fieldid.ws.v2.resources.setupdata.assettype.attributes.*;
...
@Component
@Path("assetType")
public class ApiAssetTypeResource extends SetupDataResourceReadOnly<ApiAssetType, AssetType> {
