...
@Transactional
public class ApiAttributeValueConverter extends FieldIdPersistenceService {
	...
	public List<ApiAttributeValue> convertInfoOptions(Collection<InfoOptionBean> infoOptions) {
		List<ApiAttributeValue> attribValues = new ArrayList<>();
	...
	public Set<InfoOptionBean> convertAttributeValues(List<ApiAttributeValue> apiAttributeValues, Collection<InfoOptionBean> existingOptions) {
		Set<InfoOptionBean> infoOptions = new TreeSet<>();
