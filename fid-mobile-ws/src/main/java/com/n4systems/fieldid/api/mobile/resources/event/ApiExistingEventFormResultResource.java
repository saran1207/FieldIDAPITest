...
import com.n4systems.fieldid.api.mobile.resources.eventschedule.ApiEventSchedule;
	...
	private void convertApiCriteriaResult(ApiCriteriaResult apiResult, CriteriaResult result, AbstractEvent event) {
		switch (result.getCriteria().getCriteriaType()) {
			...
			default:
				...
				throw new InternalServerErrorException("Unhandled Criteria type: " + result.getCriteria().getCriteriaType().name());
		}
