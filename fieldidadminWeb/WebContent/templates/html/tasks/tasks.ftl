...
<h2>
	...
	<@s.url id="reloadSchedulerUrl" value="reloadScheduler.action" />
	<button type="button" onclick="window.location = '<@s.text name="%{reloadSchedulerUrl}" />';">Reload</button>
	
	<@s.url id="enableDisableSchedulerUrl" value="enableDisableScheduler.action">
...
<@s.iterator id="conf" value="taskConfigs">
	<@s.url id="enableDisableTaskUrl" value="enableDisableTask.action">
