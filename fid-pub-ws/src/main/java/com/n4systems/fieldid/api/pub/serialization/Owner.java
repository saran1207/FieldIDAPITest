...
// Source file: /Users/kirillternovsky/Documents/web/fid-pub-ws/src/main/proto/Owner.proto
...
public final class Owner extends Message {
  ...
  public static final FieldOptions FIELD_OPTIONS_ID = new FieldOptions.Builder()
      .setExtension(Ext_Extensions.serialized_name, "test")
      .build();
  public static final FieldOptions FIELD_OPTIONS_NAME = new FieldOptions.Builder()
      .setExtension(Ext_Extensions.serialized_name, "NEW_NAME")
      .build();
  ...
  public Owner(String id, String name, String parentId, String code, String notes, String streetAddress, String city, String state, String country, String zip, String phone1, String phone2, String fax1, String latitude, String longitude, String contactName, String contactEmail) {
    this.id = id;
    this.name = name;
