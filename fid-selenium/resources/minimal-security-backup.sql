...
) ENGINE=InnoDB AUTO_INCREMENT=15512624 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=12461 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `eulaacceptances` VALUES (62,'2010-02-01 16:33:22','2010-02-01 16:33:22',NULL,15511596,15512597,1,'2010-02-01 16:33:22'),(63,'2010-03-30 20:35:24','2010-03-30 20:35:24',NULL,15511597,15512599,1,'2010-03-30 20:35:24'),(64,'2010-03-31 14:50:00','2010-03-31 14:50:00',NULL,15511595,15512595,1,'2010-03-31 14:50:00'),(65,'2010-05-18 19:09:54','2010-05-18 19:09:54',NULL,15511598,15512623,1,'2010-05-18 19:09:54');
...
INSERT INTO `findproductoption` VALUES (1,'rfid','RFID Number','Find asset by its RFID number'),(2,'serial','Serial Number','Find asset by its serial number'),(3,'reelid','Reel ID','Find asset by its Reel/ID number');
...
INSERT INTO `infofield` VALUES (1,'text field',6799,0,0,NULL,0,'textfield',0),(2,'select field',6799,0,1,NULL,0,'selectbox',0),(3,'combo field',6799,0,2,NULL,0,'combobox',0),(4,'Unit of Measure field',6799,0,3,5,1,'textfield',0),(5,'Text field',6801,0,0,NULL,0,'textfield',0),(6,'select field',6801,0,1,NULL,0,'selectbox',0),(7,'combo field',6801,0,2,NULL,0,'combobox',0),(8,'Unit of Measure field',6801,0,3,1,1,'textfield',0);
...
CREATE TABLE `inspections` (
  ...
  CONSTRAINT `fk_inspections_products` FOREIGN KEY (`product_id`) REFERENCES `assets` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `inspectionschedules` (
  ...
  CONSTRAINT `fk_inspectionschedules_products` FOREIGN KEY (`product_id`) REFERENCES `assets` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `inspectiontypegroups` VALUES (267,15511595,'2010-02-01 16:05:46','2010-02-01 16:05:46',NULL,'Visual Inspection','Visual Inspection',NULL,NULL),(268,15511596,'2010-02-01 16:09:11','2010-02-01 16:09:11',NULL,'Visual Inspection','Visual Inspection',NULL,NULL),(269,15511597,'2010-03-30 20:00:15','2010-03-30 21:29:44',15512599,'repair','repair',NULL,NULL),(270,15511598,'2010-05-18 19:06:41','2010-05-18 19:06:41',NULL,'Visual Inspection','Visual Inspection',NULL,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=15539093 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `productattachments` (
  ...
  CONSTRAINT `fk_productattachments_products` FOREIGN KEY (`product_id`) REFERENCES `assets` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `assets` (
  ...
  CONSTRAINT `fk_linked_product_id` FOREIGN KEY (`linked_id`) REFERENCES `assets` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE TABLE `productserial_infooption` (
  ...
  CONSTRAINT `fk_productserial_infooption_products` FOREIGN KEY (`r_productserial`) REFERENCES `assets` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `productserialextensionvalue` (
  ...
  CONSTRAINT `fk_productserialextensionvalue_products` FOREIGN KEY (`r_productserial`) REFERENCES `assets` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `productstatus` VALUES (476,'In Service',15511595,'2010-02-01 16:05:46','2010-02-01 16:05:46',NULL),(477,'Out of Service',15511595,'2010-02-01 16:05:46','2010-02-01 16:05:46',NULL),(478,'In for Repair',15511595,'2010-02-01 16:05:46','2010-02-01 16:05:46',NULL),(479,'In need of Repair',15511595,'2010-02-01 16:05:46','2010-02-01 16:05:46',NULL),(480,'Destroyed',15511595,'2010-02-01 16:05:46','2010-02-01 16:05:46',NULL),(481,'In Service',15511596,'2010-02-01 16:09:11','2010-02-01 16:09:11',NULL),(482,'Out of Service',15511596,'2010-02-01 16:09:11','2010-02-01 16:09:11',NULL),(483,'In for Repair',15511596,'2010-02-01 16:09:11','2010-02-01 16:09:11',NULL),(484,'In need of Repair',15511596,'2010-02-01 16:09:11','2010-02-01 16:09:11',NULL),(485,'Destroyed',15511596,'2010-02-01 16:09:11','2010-02-01 16:09:11',NULL),(486,'In Service',15511597,'2010-03-30 20:00:15','2010-03-30 20:00:15',NULL),(487,'Out of Service',15511597,'2010-03-30 20:00:15','2010-03-30 20:00:15',NULL),(488,'In for Repair',15511597,'2010-03-30 20:00:15','2010-03-30 20:00:15',NULL),(489,'In need of Repair',15511597,'2010-03-30 20:00:15','2010-03-30 20:00:15',NULL),(490,'Destroyed',15511597,'2010-03-30 20:00:15','2010-03-30 20:00:15',NULL),(491,'In Service',15511598,'2010-05-18 19:06:41','2010-05-18 19:06:41',NULL),(492,'Out of Service',15511598,'2010-05-18 19:06:41','2010-05-18 19:06:41',NULL),(493,'In for Repair',15511598,'2010-05-18 19:06:41','2010-05-18 19:06:41',NULL),(494,'In need of Repair',15511598,'2010-05-18 19:06:41','2010-05-18 19:06:41',NULL),(495,'Destroyed',15511598,'2010-05-18 19:06:41','2010-05-18 19:06:41',NULL);
...
CREATE TABLE `projects_products` (
  ...
  CONSTRAINT `fk_projects_products_products` FOREIGN KEY (`products_id`) REFERENCES `assets` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `seenitstorageitem` VALUES (1,'2010-02-01 16:33:22','2010-02-01 16:33:22',NULL,15512597),(2,'2010-03-30 20:35:25','2010-03-30 20:35:25',NULL,15512599),(3,'2010-03-31 14:50:01','2010-03-31 14:50:01',NULL,15512595),(4,'2010-05-18 19:09:54','2010-05-18 19:09:54',NULL,15512623);
...
INSERT INTO `seenitstorageitem_itemsseen` VALUES (1,'SetupWizard'),(2,'SetupWizard'),(3,'SetupWizard'),(4,'SetupWizard');
...
INSERT INTO `serialnumbercounter` VALUES (476,15511595,1,'000000',365,'2010-01-01 00:00:00'),(477,15511596,1,'000000',365,'2010-01-01 00:00:00'),(478,15511597,1,'000000',365,'2010-01-01 00:00:00'),(479,15511598,1,'000000',365,'2010-01-01 00:00:00');
...
INSERT INTO `statesets_states` VALUES (343,1094,0),(343,1095,1),(344,1096,0),(344,1097,1),(344,1098,2),(345,1099,0),(345,1100,1),(346,1101,0),(346,1102,1),(346,1103,2),(347,1104,0),(347,1105,1),(348,1106,0),(348,1107,1),(348,1108,2),(349,1109,0),(349,1110,1),(350,1111,0),(350,1112,1),(350,1113,2);
...
CREATE TABLE `subproducts` (
  ...
  CONSTRAINT `fk_subproducts_masterproduct` FOREIGN KEY (`masterproduct_id`) REFERENCES `assets` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_subproducts_subproduct` FOREIGN KEY (`product_id`) REFERENCES `assets` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tenants` (
  ...
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15511599 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tenants` VALUES (15511550,'fieldid'),(15511595,'test-vendor'),(15511596,'test-distributor'),(15511597,'security-check'),(15511598,'write-company');
