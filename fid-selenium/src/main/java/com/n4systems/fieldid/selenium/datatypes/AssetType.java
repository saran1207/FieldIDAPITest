...
public class AssetType {
	...
	String assetDescriptionTemplate;
	...
	public String getAssetDescriptionTemplate() {
		return assetDescriptionTemplate;
	}
	...
	public void setAssetDescriptionTemplate(String s) {
		assetDescriptionTemplate = s;
	}
