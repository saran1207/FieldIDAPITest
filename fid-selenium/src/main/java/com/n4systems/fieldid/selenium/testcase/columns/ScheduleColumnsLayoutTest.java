...
public class ScheduleColumnsLayoutTest extends PageNavigatingTestCase<ColumnLayoutPage> {
    ...
    public void test_default_reporting_columns() {
        ...
        List<String> expectedDefaultColumns = Arrays.asList("Scheduled Date", "Status", "Days Past Due", "ID Number", "Asset Type", "Customer Name", "Location", "Event Type", "Last Event Date");
