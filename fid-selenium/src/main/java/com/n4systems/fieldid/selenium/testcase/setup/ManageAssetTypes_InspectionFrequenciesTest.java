...
public class ManageAssetTypes_InspectionFrequenciesTest extends ManageAssetTypesTestCase {
	...
	public void test_add_and_remove_inspection_schedule() throws Exception {
		addTestAssetType();
		addInspectionTypeToTestAsset(TEST_INSPECTION_TYPE);
	...
	private void addInspectionTypeToTestAsset(String inspectionType) {
