...
public class AutoAttributeView extends ExternalModelView {
	...
	@ExportField(title = "I:", order = 10, handler = AutoAttributeMapSerializationHandler.class, validators = {NotNullValidator.class})
	private Map<String, String> inputs = new LinkedHashMap<String, String>();

	@ExportField(title = "O:", order = 20, handler = AutoAttributeMapSerializationHandler.class, validators = {NotNullValidator.class})
