...
public class InspectionSaver {
	private final Logger logger = Logger.getLogger(InspectionSaver.class);
	...
	public InspectionSaver(LegacyProductSerial legacyProductManager, InspectionScheduleManager inspectionScheduleManager, PersistenceManager persistenceManager, 
	...
	void updateScheduleOwnerShip(Inspection inspection, Long userId) {
	 ...
	 */
	public Inspection attachFilesToSubInspection(InspectionManagerImpl inspectionManagerImpl, Inspection inspection, SubInspection subInspection, List<FileAttachment> uploadedFiles) throws FileAttachmentException {
		return attachFilesToSubInspection(inspection, subInspection, uploadedFiles);
	}
