...
public class GetAssetsRequestHandler implements RequestHandler<AssetRequest, AssetListResponse>{
	...
	private final ModelToServiceConverter<Product, ProductServiceDTO> converter;
	
	public GetAssetsRequestHandler(FilteredInListLoader<Product> productLoader, ModelToServiceConverter<Product, ProductServiceDTO> converter) {
