...
/**
 * A loader to test that a ProductType attachment can be loaded from a given networkId.  The
...
public class ProductTypeFileAttachmentIdByProductNetworkIdExistsLoader extends Loader<Boolean> {
	...
	protected Boolean load(EntityManager em) {
		 ...
		 * to attachmentId and who are attached to the product types of products with a 
