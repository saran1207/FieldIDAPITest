...
public class UserExporter implements Exporter {
	private final ExportMapMarshaler<UserView> marshaller;
	private final ListLoader<User> userLoader;
	private final ModelToViewConverter<User, UserView> converter;

	public UserExporter(ListLoader<User> eventLoader, ExportMapMarshaler<UserView> marshaller, ModelToViewConverter<User, UserView> converter) {
