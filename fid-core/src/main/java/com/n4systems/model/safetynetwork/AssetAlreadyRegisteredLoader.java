...
public class AssetAlreadyRegisteredLoader extends SecurityFilteredLoader<Boolean> {

    private long networkId;

    public AssetAlreadyRegisteredLoader(SecurityFilter filter) {
        super(filter);
    }
    ...
    public AssetAlreadyRegisteredLoader setNetworkId(long networkId) {
