 ...
 * attachment is considered loadable iff it is attached to one or more of the AssetTypes
 * of the Assets with a given networkId. 
 */
public class AssetTypeFileAttachmentIdByAssetNetworkIdExistsLoader extends Loader<Boolean> {
	...
	public AssetTypeFileAttachmentIdByAssetNetworkIdExistsLoader setNetworkId(Long networkId) {
		this.networkId = networkId;
		return this;
	}

	public AssetTypeFileAttachmentIdByAssetNetworkIdExistsLoader setAttachmentId(Long attachmentId) {
