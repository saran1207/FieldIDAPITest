 ...
 */
public class AssetTypeFileAttachmentIdByProductNetworkIdExistsLoader extends Loader<Boolean> {
	...
	public AssetTypeFileAttachmentIdByProductNetworkIdExistsLoader setNetworkId(Long networkId) {
		this.networkId = networkId;
		return this;
	}

	public AssetTypeFileAttachmentIdByProductNetworkIdExistsLoader setAttachmentId(Long attachmentId) {
