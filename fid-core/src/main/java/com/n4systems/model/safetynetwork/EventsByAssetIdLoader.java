...
public class EventsByAssetIdLoader extends ListLoader<Event> {

    private long assetId;

    public EventsByAssetIdLoader(SecurityFilter filter) {
        super(filter);
    }
    ...
    public EventsByAssetIdLoader setAssetId(long assetId) {
