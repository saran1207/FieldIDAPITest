...
@Entity
@Table(name = "widget_configurations_event_completeness")
@PrimaryKeyJoinColumn(name="id")
public class EventCompletenessWidgetConfiguration extends WidgetConfiguration implements ConfigurationWithGranularity {
	...
	@Override
	public EventCompletenessWidgetConfiguration copy() {
		EventCompletenessWidgetConfiguration copy = (EventCompletenessWidgetConfiguration) super.copy();
		copy.setOrg(getOrg());
