...
public class SubEvent extends AbstractEvent implements SecurityEnhanced<SubEvent> {
	...
	public static final String[] ALL_FIELD_PATHS = { "modifiedBy.userID", "eventForm.sections", "type.supportedProofTests", "type.infoFieldNames", "attachments", "results", "asset", "asset.infoOptions", "infoOptionMap"};
