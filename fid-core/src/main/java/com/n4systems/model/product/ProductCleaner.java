...
public class ProductCleaner extends AbstractEntityCleaner<Asset> {
	...
	public ProductCleaner(Cleaner<InfoOptionBean> infoOptionCleaner, Cleaner<AssetSerialExtensionValue> productSerialExtensionValueCleaner) {
