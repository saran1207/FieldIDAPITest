...
public class ReadOnlyUserCountLoader extends Loader<Long> implements LimitLoader {
	private Long tenantId;
	
	public ReadOnlyUserCountLoader() {}
	...
	protected Long load(EntityManager em) {
		...
		builder.addWhere(WhereClauseFactory.create("userType", UserType.READONLY));
	...
	public ReadOnlyUserCountLoader setTenantId(Long tenantId) {
	...
	public LimitType getType() {
		return LimitType.READONLY_USERS;
	}
