...
public class BaseEventMapBuilder extends AbstractMapBuilder<Event> {
	...
	public BaseEventMapBuilder(MapBuilder<User> performedByMapBuilder, MapBuilder<EventTypeGroup> typeGroupMapBuilder, MapBuilder<InternalOrg> orgMapBuilder, MapBuilder<BaseOrg> ownerMapBuilder, MapBuilder<Event> scheduleMapBuilder, MapBuilder<AssetStatus> assetStatusMapBuilder
	...
	public BaseEventMapBuilder(DateTimeDefiner dateDefiner) {
		this(
			new PerformedByMapBuilder(),
			new EventTypeGroupMapBuilder(),
			new OrganizationMapBuilder(),
			new OwnerMapBuilder(),
			new EventScheduleMapBuilder(dateDefiner),
