...
public class SavedReportService extends SavedSearchService<SavedReportItem, EventReportCriteria> {
    ...
    protected void storeTransientColumns(EventReportCriteria searchCriteria) {
        ...
        List<ColumnMappingGroupView> dynamicEventColumns = dynamicColumnsService.getDynamicEventColumnsForReporting(searchCriteria.getEventType(), eventTypeService.getEventTypesIncludingActions(eventTypeGroup == null ? null : eventTypeGroup.getId()));
