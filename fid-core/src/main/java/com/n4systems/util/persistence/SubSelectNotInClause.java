...
public class SubSelectNotInClause implements WhereClause<QueryBuilder<?>> {
	...
	public SubSelectNotInClause() {}

	public SubSelectNotInClause(String param) {
		this(param, null);
	}

	public SubSelectNotInClause(String param, QueryBuilder<?> subSelect) {
		this.param = param;
	...
	public String getClause(FromTable table) throws InvalidQueryException {
		...
		String clause = table.prepareField(param) + " NOT IN ( " + subSelect.getQueryString() + " )";
		return clause;
	}
