...
public class AssetToModelConverter implements ViewToModelConverter<Asset, AssetView> {
	...
	public AssetToModelConverter(OrgByNameLoader orgLoader, NonIntegrationOrderManager nonIntegrationOrderManager, ProductStatusByNameLoader productStatusLoader, InfoOptionMapConverter optionConverter) {
