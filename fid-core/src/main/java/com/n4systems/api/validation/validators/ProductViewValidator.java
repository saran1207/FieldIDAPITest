...
public abstract class ProductViewValidator implements FieldValidator {
	...
	public <V extends ExternalModelView> ValidationResult validate(Object fieldValue, V view, String fieldName, SecurityFilter filter, Map<String, Object> validationContext) {
		return validate(fieldValue, (ProductView)view, fieldName, filter, (AssetType)validationContext.get(PRODUCT_TYPE_KEY));
	}

	abstract public ValidationResult validate(Object fieldValue, ProductView view, String fieldName, SecurityFilter filter, AssetType type);
