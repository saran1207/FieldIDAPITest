...
public class YNValidatorTest {
	...
	public void test_pass_conditions() { 
		assertTrue(validator.validate("Y", null, null, null, null).isPassed());
		assertTrue(validator.validate("N", null, null, null, null).isPassed());
	}
	...
	public void test_fail_conditions() { 
		assertFalse(validator.validate("b", null, null, null, null).isPassed());
		assertFalse(validator.validate("", null, null, null, null).isPassed());
		assertFalse(validator.validate("yn", null, null, null, null).isPassed());
	}
