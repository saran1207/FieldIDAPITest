...
import static com.n4systems.servicedto.builders.InspectionServiceDTOBuilder.anInspectionServiceDTO;
import static com.n4systems.servicedto.builders.ProductServiceDTOBuilder.aProductServiceDTO;
...
public class PopulateAssignedUserConverterTest {
    ...
    public void should_fetch_assigned_user_from_a_the_user_loader() throws Exception {
        ...
        final UserFilteredLoader loader = createMock(UserFilteredLoader.class);
    ...
    public void should_set_the_create_the_assigned_to_update_with_the_assigned_user() throws Exception {
        ...
        final UserFilteredLoader loader = createUserFilteredLoaderFor(assignedUser);
        PopulateAssignedUserConverter sut = new PopulateAssignedUserConverter(loaderFactoryWith(loader)) {
            @Override
            protected UserFilteredLoader createUserFilteredLoaderWithArchived() {
                return loader;
    ...
    public void should_throw_conversion_exception_if_assigned_to_user_can_not_be_laoded() throws Exception {
        ...
        final UserFilteredLoader loader = createUserFilteredLoaderFor(MISSING_USER);
        PopulateAssignedUserConverter sut = new PopulateAssignedUserConverter(loaderFactoryWith(loader)) {
            @Override
            protected UserFilteredLoader createUserFilteredLoaderWithArchived() {
                return loader;
