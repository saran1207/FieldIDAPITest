...
/**
 * Due to large changes in how we handle DownloadTasks, this test has been disabled.
 *
 * TODO: Create a new test that actually works with the new DownloadTask design...
 */
